...
export const MARKER_COLORS = ["red", "blue", "green", "orange", "purple"] as const;
...
export const markerSchema = z.object({
  ...
  color: z.enum(MARKER_COLORS).optional().describe("Marker color"),
});
...
export const mapSchema = z.object({
  ...
  markers: z.array(markerSchema).describe("Markers to draw. Always send the complete set."),
});
